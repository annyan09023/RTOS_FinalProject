...
/*MAKING REVISION TO REALIZE PRIORITY DONATION, SOLVING PRIORITY INVERSION PROBLEM
 *ANNYAN
 */
#ifndef __OS_H
#define __OS_H  1
...
struct TCB{
	...
	unsigned short Id;     /* Thread Id, used for debugging*/
	unsigned short priority;  /* Priority (used in Lab 3) */
	unsigned short priority_temp; /****for priority donation*********annyan*/
